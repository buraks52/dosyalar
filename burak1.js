(function(qc) {
    ...
    kb.N = "<div class='choose-nickname-view'><img src=\"" /><div class='dialog'><h1>Choose nickname</h1><div class='label-input'><label>Nick:</label><input data-hook='input' type='text' /></div><button data-hook='ok'>Ok</button></div></div>";
