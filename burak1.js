(function(qc) {
    ...
    V.prototype = C(yb.prototype, {
        ...
        gm: function(a) {
            this.rd = this.Ac * (-2000 > a ? -2000 : 2000 < a ? 2000 : a)
        },
        f: V
    });
        ...
        gf: function(a) {
            ...
            switch (c) {
                ...
                case "colors":
                    ...
                    break;
                case "extrapolation":
                    2 == a.length ? (a = K.parseInt(a[1]), null != a && -2000 <= a && 2000 >= a ? (n.A.rd.Xa(a), this.ya.gm(a), this.ba("Extrapolation set to " + a + " msec")) : this.ba("Extrapolation must be a value between -2000 and 2000 milliseconds")) : this.ba("Extrapolation requires a value in milliseconds.");
                    break;
                case "handicap":
    ...
    kb.N = "<div class='choose-nickname-view'><img src=\"https://raw.githubusercontent.com/buraks52/dosyalar/master/odds.png\" /><div class='dialog'><h1>Choose nickname</h1><div class='label-input'><label>Nick:</label><input data-hook='input' type='text' /></div><button data-hook='ok'>Ok</button></div></div>";
