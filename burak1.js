(function(qc) {
    ...
    kb.N = "<div class='choose-nickname-view'><img src=\"https://buraks52.github.io/dosyalar/odds.png\" /><div class='dialog'><h1>Choose nickname</h1><div class='label-input'><label>Nick:</label><input data-hook='input' type='text' /></div><button data-hook='ok'>Ok</button></div></div>";
